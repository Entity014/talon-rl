...
def test_dim_includes_payload_under_explicit_observed_rewarded():
    ...
    non_payload = (
        ...
        + cfg.dynamic_friction_dim + cfg.joint_damping_dim
    )
...
def test_default_dim_is_12():
    # The V4 teacher's Env Encoder input width; a silent change here would
    # make it load a mismatched encoder rather than fail.
    assert ExtrinsicsCfg().dim == 12
