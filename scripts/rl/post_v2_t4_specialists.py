...
def main():
    ...
    try:
        ...
        for idx,label in enumerate(ORDER):
            ...
            m=T4SharedActorCritic(obs.shape[-1],ad).cuda();initialize_from_rsl_m01(m,args.checkpoint,device="cpu")
        ...
        report={
          ...
          "updates":args.updates,"objective_order":OBJ_NAMES,"fixed_preferences":{k:v.tolist() for k,v in PREFS.items()},
