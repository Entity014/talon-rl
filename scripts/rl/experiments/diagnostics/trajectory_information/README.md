# `diagnostics/trajectory_information`
...
|---|---:|---|---|
| `objective_sufficiency.py` | 165 | — | **no docstring** |

## Run directories these touch

- `runs/trajectory_objective_sufficiency_audit-2026-09-24`
