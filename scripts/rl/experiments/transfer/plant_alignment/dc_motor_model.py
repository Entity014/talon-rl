...
def run_phase3_t3_generate_dcmotor_model():
    """Run former phase3_t3_generate_dcmotor_model.py stage."""
...
def run_phase3_t3a_one_step_compare():
    """Run former phase3_t3a_one_step_compare.py stage."""
    from pathlib import Path
    import json,sys
    import mujoco
    import numpy as np
...
def run_phase3_t3b_nominal_dynamics():
    """Run former phase3_t3b_nominal_dynamics.py stage."""
    from pathlib import Path
    ...
    OUT=ROOT/"runs/phase3_t3b_nominal_dynamics";OUT.mkdir(parents=True,exist_ok=True)
    ...
    def main():
        ...
        rep={"schema":"phase3_t3b_nominal_dynamics_v1","rows":rows,
...
STAGES = {
    "phase3_t3_generate_dcmotor_model": run_phase3_t3_generate_dcmotor_model,
    "phase3_t3a_one_step_compare": run_phase3_t3a_one_step_compare,
    "phase3_t3b_nominal_dynamics": run_phase3_t3b_nominal_dynamics,
}
