...
RUNS={"recent3":ROOT/"runs/post_v2_t5_c21_recent3-2026-09-23","recent12warm":ROOT/"runs/post_v2_t5_c21_recent12warm-2026-09-23"}
...
def main():
 ...
 try:
  ...
  for arm in RUNS:
   ...
   agg[arm]=traj
  out["aggregate"]=agg
  p=RUNS["recent12warm"]/"replay_audit.json";p.write_text(json.dumps(out,indent=2)+"\n")
  for arm in ("recent3","recent12warm"):
   print("\\n",arm)
